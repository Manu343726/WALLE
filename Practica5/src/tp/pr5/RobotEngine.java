...
public class RobotEngine extends Event<RobotEngineChangeEventArgs>{
    ...
    */
    public void requestQuit(){
        RobotEngineChangeEventArgs args = new RobotEngineChangeEventArgs(RobotEngineChangeType.QUIT_REQUESTED, RobotEngineChangeEventArgs.UNMEANING_VALUE /* el campo "value" no tiene sentido en éste evento (Aparece explicado en la documentación) */);
